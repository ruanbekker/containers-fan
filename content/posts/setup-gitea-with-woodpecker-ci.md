...
![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163272509-11e317ca-337f-4314-bcc3-82e18773181d.png)

Then you should be redirected to the main gitea menu:

![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163272782-90f2dcbf-1a68-4e88-a46f-25de97601349.png)
...
![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163273031-2ccdbe54-fadb-4ca0-bffe-099f8a0c6277.png)
...
![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163273219-63e08459-5a5b-4e3e-addd-bdab8a264ac9.png)
...
![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163274634-abae7079-f20e-4ce8-a367-8140a52c9a0f.png)
...
![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163274746-8867267b-a3c2-4463-aeaf-251d06c7b93d.png)

Select "Authorize Application", then we will be logged into woodpecker server:

![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163274961-f8d445fb-5a39-4b24-a203-a6151e925d2c.png)

Head back to gitea, and from the top right hand corner, select "+" and select "New Repository":

![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163275125-33d3751f-46a2-43aa-9d3c-33a033418528.png)

Provide a repository name and select "Initialize Repository":

![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163275314-1e1cce14-0e3d-4e5a-b52f-a433a820cd7d.png)

Then select "Create Repository":

![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163275478-8bf1d173-89d3-4286-9b58-3cefc79806a3.png)

Head back to woodpecker server, then on the right hand side select "Add Repository":

![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163275621-5c1b1e2a-2f9e-4e51-81b2-61ea59e7d804.png)

Then select "Reload Repositories", and you should see your repository appear:

![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163275706-17b780a4-31e4-475a-96f8-6a5a0b9e03c5.png)

Then select "enable" and you should see a view with no builds:

![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163275779-4447b2bd-3551-45bb-90d4-9c0ea9bf5ed1.png)
...
![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163276435-0be62e76-8fd9-4d18-8224-5f45ed4294be.png)

When we select the build, we can see our build consisted of a clone step and our step which we called "first-job":

![woodpecker-ci-image](https://user-images.githubusercontent.com/567298/163276517-c1e219a5-6ec5-4137-a585-81736143de10.png)
